...
The first dataset contains multiple variables regarding the amount and types of trash and collected by Mr. Trash Wheel and number of homes powered by the energy created. The dimensions of this data frame are \[285, 14\] \[rows x columns\] and there are 284 total observations, with the last row containing variable totals. The second data frame contains information about precipitation in 2016 and 2017 and has dimensions of \[24, 3\] \[rows x columns\]. There are 12 months worth of data for 2017 and 12 for 2016. The total precipitation for 2017 was 32.93. The median number of sports balls collected was 8.
...
This dataset contains information from 404 distinct locations and 51 distinct states - including the District of Columbia. New Jersey is the state with the most observations. In 2002, the median of the "excellent" response values was 23.6.
...
<img src="p8105_hw2_ja3314_files/figure-markdown_github/unnamed-chunk-12-1.png" width="90%" />
...
<img src="p8105_hw2_ja3314_files/figure-markdown_github/unnamed-chunk-13-1.png" width="90%" />
